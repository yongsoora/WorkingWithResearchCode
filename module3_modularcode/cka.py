...
from https://github.com/patrickmineault/research_code
"""
f = open('module3_modularcode/data/matrices.pkl', 'rb')
...
plt.savefig('module3_modularcode/results/closeness.png')